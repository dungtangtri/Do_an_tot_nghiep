...
import com.dung.spring.application.payload.request.SignupRequest;
import com.dung.spring.application.payload.response.MessageResponse;
import com.dung.spring.application.payload.response.UserInfoResponse;
import com.dung.spring.application.security.jwt.JwtUtils;
...
import com.dung.spring.application.payload.request.LoginRequest;
import com.dung.spring.application.repository.RoleRepository;
...
public class AuthController {
  ...
  public ResponseEntity<?> getCurrentUserDetail(@AuthenticationPrincipal UserDetailsImpl user){
    if(user == null){
